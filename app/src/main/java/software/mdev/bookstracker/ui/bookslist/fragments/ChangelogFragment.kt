...
class ChangelogFragment : Fragment(R.layout.fragment_changelog) {
    ...
    private fun getVersionStrings(): List<Array<String>> {
        ...
        val version_1_7_0 = arrayOf(
            getString(R.string.changelog_ver_1_7_0),
            getString(R.string.changelog_date_1_7_0),
            getString(R.string.changelog_1_7_0_a),
            getString(R.string.changelog_1_7_0_b),
            getString(R.string.changelog_1_7_0_c),
            getString(R.string.changelog_1_7_0_d),
            getString(R.string.changelog_1_7_0_e),
            getString(R.string.changelog_1_7_0_f),
            getString(R.string.changelog_1_7_0_g),
            getString(R.string.changelog_1_7_0_h),
            getString(R.string.changelog_1_7_0_i),
            getString(R.string.changelog_1_7_0_j)
        )

        val version_1_7_1 = arrayOf(
            getString(R.string.changelog_ver_1_7_1),
            getString(R.string.changelog_date_1_7_1),
            getString(R.string.changelog_1_7_1_a),
            getString(R.string.changelog_1_7_1_b),
        ...
        val version_1_8_1 = arrayOf(
            getString(R.string.changelog_ver_1_8_1),
            getString(R.string.changelog_date_1_8_1),
        ...
        val version_1_9_1 = arrayOf(
            getString(R.string.changelog_ver_1_9_1),
            getString(R.string.changelog_date_1_9_1),
            getString(R.string.changelog_1_9_1_a)
        )
