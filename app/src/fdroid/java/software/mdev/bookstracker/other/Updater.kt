...
class Updater {
    ...
    fun checkForAppUpdate(context: Context, showAppUpdated: Boolean) = CoroutineScope(Dispatchers.Main).launch {
        ...
        appUpdater
            ...
            .setContentOnUpdateAvailable(context.getString(R.string.setContentOnUpdateAvailable_fdroid))
            ...
            .setContentOnUpdateNotAvailable(context.getString(R.string.setContentOnUpdateNotAvailable_fdroid))
